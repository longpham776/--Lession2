...
<span class="d-inline-block"><h5>Search found <?php echo count($dataProduct) ?> results</h5></span>
        ...
        <tr>
            ...
            <?php
                foreach ($dataCategory as $cate) {
                    if($pro["category"]==$cate["id"]){
                        echo $cate["name"];
                    }
                }
            ?>
            </td>
            <td><img src="./assets/<?php echo $pro["image"] ?>" alt="Image Product"></td>
            <td>
...
<nav aria-label="Page navigation">
    ...
    <?php
        for ($i=1; $i <= count($dataProduct)/10 ; $i++) { 
    ?>
